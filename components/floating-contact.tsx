...
export function FloatingContact(){
  ...
  return <div ref={widgetRef} className={styles.widget}>
    {open&&<div className={styles.menu} id="floating-contact-menu">
      <a href={siteConfig.contact.lineUrl} target="_blank" rel="noreferrer"><span className={styles.lineIcon} aria-hidden="true">LINE</span><span>ติดต่อทาง LINE</span></a>
      <a href="tel:029525414"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7.1 3.5 9.7 7 8.2 9.1c1.25 2.55 3.05 4.35 5.6 5.6l2.1-1.5 3.5 2.6-.55 3.05c-.17.94-1.04 1.59-1.99 1.5C9.98 19.7 4.3 14.02 3.65 7.14c-.09-.95.56-1.82 1.5-1.99L7.1 3.5Z"/></svg><span>โทรหาเรา</span></a>
